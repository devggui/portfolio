  ...
  return (
    <section className="flex flex-col items-center justify-between text-center sm:flex-row-reverse sm:text-left">      
      <div className= "bg-gradient-to-t from-[var(--black-op)] to-transparent">
        <img src="../../public/photo/profile-photo.png" alt="Foto de perfil"/>     
      </div>
      <div className="sm:w-3/5">
        <h1 className="text-white text-2xl font-bold mb-2 mt-7 sm:text-4xl">Oi! Eu sou <span className="border-b-[3px] border-[var(--cyan-gradient-from)]">Guilherme Silva</span>.</h1>
