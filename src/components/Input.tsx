...
export function Input(props: Input) {
  return (
    <div className="w-full border-b-2 border-white relative mt-5">        
      <input type={props.type} name={props.name} id={props.id} placeholder={props.placeholder} className="text-base text-white block w-full h-14 bg-transparent pt-0 pr-11 pb-0 pl-7" />
